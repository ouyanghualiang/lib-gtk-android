...
ZIP=/tmp/gtk+-3.12.2.zip
DEVZIP=/tmp/gtk+-dev-3.12.2.zip
...
mkdir -p share/doc/gtk+-3.12.2
cp -p /home/ouyang/aqqw/lib-native-activity/jni/gtk/distsrc/COPYING share/doc/gtk+-3.12.2

mkdir -p share/doc/gtk+-dev-3.12.2
cp -p /home/ouyang/aqqw/lib-native-activity/jni/gtk/distsrc/COPYING share/doc/gtk+-dev-3.12.2
...
zip -r -D $ZIP share/doc/gtk+-3.12.2
...
zip -r $DEVZIP share/doc/gtk+-dev-3.12.2
